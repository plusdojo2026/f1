...
public class UsersDAOTest {
	...
	public static void main(String[] args) {
		...
		int insRec = userDao.insert(new UsersDTO(0, "f1@gmail.com", "password", 1, ""));
		if (insRec > 0) {
		...
		List<UsersDTO> cardListUp = userDao.select(new UsersDTO(0, "f1@gmail.com", "", 1, ""));
		UsersDTO upRec = cardListUp.get(0);
		upRec.setPrefecture_id(2);
