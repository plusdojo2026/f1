...
public class FeaturedItemsDTO implements Serializable {
	...
	private String featured_name;	//目玉商品名
	private LocalDate start_date;	//目玉商品開始日
	private LocalDate end_date;		//目玉商品終了日
	private String ap_name;			//代替商品名
	
	//コンストラクタ
	public FeaturedItemsDTO(int featured_item_id, int store_id, int price, String featured_name, LocalDate start_date,
			LocalDate end_date, String ap_name) {
		super();
